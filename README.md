...
2. Place trained models inside /models/:
  -->age_model.h5
  -->gender_model.h5

3. In terminal (from project root):
  -->python gui/app_gui.py

4. Upload an image, select hair length manually, and click "Predict Gender" to view results.
